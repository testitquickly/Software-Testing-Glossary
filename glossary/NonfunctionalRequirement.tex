...
A \rindex{\textbf{R}!Requirements}requirement that does not relate to functionality, but to attributes such as reliability, efficiency, usability, maintainability and portability.
...
\begin{quote}
How you will test the Effectiveness of \rindex{\textbf{W}!MS Word}MS Word processor? :)
\end{quote} 
