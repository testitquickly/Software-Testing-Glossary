...
This process is very annoying and costs are high, but we can drive it in a smart way, trough \index{Impact Analysis}Impact Analysis ([p.\pageref{sec:Impact Analysis}]).

\index{Regression Testing}So, every system (social, political, military or software system) should continuously expand his functional possibilities to survive. This is a \textbf{Progress}.
...
You will be a great donkey, if you will advance in 'Regression testing' having only old \index{Test Case}test cases, '\textit{Cause this is just a re-test, right, ma?}'. You will need new test cases because of ANY significant change in software structure.