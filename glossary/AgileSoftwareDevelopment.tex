...
\begin{quote}
The same with \index{SCRUM}SCRUM [p.\pageref{sec:SCRUM}] — this is not a methodology too, this is a software development \emph{framework} (a common strategy) for managing product development, driven by agile principles. 
