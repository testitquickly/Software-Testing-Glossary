...
Means any software development approach, based and guided by \rindex{\textbf{A}!Agile Software Development}agile principles~(\url{http://agilemanifesto.org/}).
...
\begin{quote}
The same with \rindex{\textbf{S}!SCRUM}SCRUM [p.\pageref{sec:SCRUM}]~\textemdash~this is not a methodology too, this is a software development \emph{framework} (a common strategy) for managing product development, driven by agile principles. 
