...
\rindex{\textbf{D}!Defect}A flaw in a component or system that can cause the component or system to fail to perform its required function, e.g. an incorrect statement or data definition.

Usually we name it \rindex{\textbf{B}!Bug}Bug [p.\pageref{sec:Bug}].
...
A document (an item in \rindex{\textbf{J}!Jira}Jira) reporting on any flaw in a component or system that can cause the component or system to fail to perform its required function.
