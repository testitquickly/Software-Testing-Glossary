...
The term \index{Ad hoc testing}'\emph{ad hoc}' has a Latin language origin, and can be translated like \begin{quote}
...
Some monkeys think that the Ad Hoc testing is the same as \index{Monkey Testing}'Monkey Testing' ([p.\pageref{sec:Monkey Testing}]). They're wrong.
