...
\rindex{\textbf{S}!Smoke Testing}This is just a convenient metaphor, defining a process of superficial testing, required to being done before the real, deeper advanced testing started.
...
Usually normal people call this checking \rindex{\textbf{S}!Sanity Testing}'sanity testing' (and developers do the same), others (factory engineers) \rindex{\textbf{I}!Integrity Testing}'integrity testing'. As manual functional testers, we called it 'Smoke testing'.
...
Smoke testing is always based on a subset of defined/planned \rindex{\textbf{T}!Test Case}test cases, that cover the main functionality of a component or system, to ascertaining that the most crucial functions of a program work, but not bothering with finer details.
