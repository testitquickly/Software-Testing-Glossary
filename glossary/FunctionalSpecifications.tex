...
\rindex{\textbf{F}!Functional Specification}This is an extention of a Functional \rindex{\textbf{R}!Requirements}Requirement [p.\pageref{sec:Functional Requirement}].
