...
\rindex{\textbf{P}!Pairwise}A powerful test design technique. Test cases are designed to execute all possible discrete combinations of each pair of input parameters. 
